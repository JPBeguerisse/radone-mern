...
const userSlice = createSlice({
    ...
    reducers: {   // Les reducers définissent comment l'état évolue en réponse aux actions.
...
export const {  getUserRequested, getUserSuccess, getUserFailed } = userSlice.actions;
